...
state=Indonesia
locality=Indonesia
organization=www.panel.sshaxor.my.id
organizationalunit=www.panel.sshaxor.my.id
commonname=www.panel.sshaxor.my.id
...
wget -O /etc/accel-ppp.conf "https://linkkalian/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://raw.githubusercontent.com/stunnel478/stunnel/main/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://raw.githubusercontent.com/stunnel478/stunnel/main/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://raw.githubusercontent.com/stunnel478/stunnel/main/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://raw.githubusercontent.com/stunnel478/stunnel/main/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
